...
function CreateProduct() {
    ...
    const handleUpload = async e =>{
        ...
        try {
            ...
            if(file.size > 1024 * 1024) // 1mb
                return alert("Tamaño demasiado grande!")
    ...
    const handleSubmit = async e =>{
        ...
        try {
            if(!isAdmin) return alert("No eres Administrador")
            if(!images) return alert("No se subio la Imagen")
        ...
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    value={product.description} rows="25" onChange={handleChangeInput} />
                </div>

                <div className="row">
                    <label htmlFor="content">Link de Mercado Libre</label>
                ...
                <button type="submit">{onEdit? "Update" : "Crear"}</button>
            </form>
        </div>
    )
}
